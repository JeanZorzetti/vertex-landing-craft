        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              Fique por dentro das últimas tendências, estratégias e novidades do marketing digital que estão transformando negócios.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-navy via-navy-dark to-navy relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="v-pattern-newsletter" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                <path d="M15 0 L22.5 15 L30 0" stroke="#D4AF37" strokeWidth="2" fill="none" opacity="1"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#v-pattern-newsletter)"/>
          </svg>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Quer receber <span className="text-gold">conteúdos exclusivos</span>?
            </h2>
